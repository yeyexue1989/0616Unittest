...
class prepareExamine2Zhuanzhe(unittest.TestCase):
    def setUp(self):
    ...
    def test_prepare_examine2_zhuanzhe(self):
        driver = self.driver
        ...
        time.sleep(1)
        driver.find_element_by_xpath("//div[@id='app']/div/div/div[3]/section/div/div/div/div/div/div/div/div[3]/div").click()
        time.sleep(1)
        ...
        driver.find_element_by_xpath("//textarea").send_keys(u"工程初设专责审核通过测试")
        time.sleep(3)
        driver.find_element_by_xpath("/html/body/div[2]/div/div[3]/span/button[2]/span").click()
        time.sleep(2)
        driver.find_element_by_xpath("//div[@id='newMenuBox']/div/div[2]/ul/li[3]/div").click()
        # time.sleep(1)
        driver.find_element_by_xpath("//div[@id='newMenuBox']/div/div[2]/ul/li[3]/ul/li[4]").click()
        time.sleep(3)
        print("工程初设专责审核成功！！！")

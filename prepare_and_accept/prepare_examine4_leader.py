...
class prepareExamine4Leader(unittest.TestCase):
    def setUp(self):
    ...
    def test_prepare_examine4_leader(self):
        driver = self.driver
        ...
        driver.find_element_by_id("input-username").send_keys(u"艾永恒")
        time.sleep(1)
        ...
        time.sleep(1)
        driver.find_element_by_xpath("//textarea").send_keys(u"测试工程试验领导审核通过")

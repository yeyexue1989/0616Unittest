...
class prepareReportClass(unittest.TestCase):
    def setUp(self):
    ...
    def test_prepare_report(self):
        ...
        driver.find_element_by_xpath("//div[@id='app']/div/div/div[3]/section/div/div/div/div/div/div/div/div[3]/div/button[4]/span").click()
        time.sleep(1)

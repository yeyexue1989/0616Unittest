...
class prepareExamine3Zhuanzhe(unittest.TestCase):
    def setUp(self):
    ...
    def test_prepare_examine3_zhuanzhe(self):
        driver = self.driver
        ...
        driver.find_element_by_xpath("//textarea").send_keys(u"测试工程施工专责审核通过")
        time.sleep(1)
        driver.find_element_by_xpath("//span/button[2]/span").click()
        time.sleep(1)
        driver.find_element_by_xpath("//div[@id='newMenuBox']/div/div[2]/ul/li[3]/div").click()
        driver.find_element_by_xpath("//div[@id='newMenuBox']/div/div[2]/ul/li[3]/ul/li[5]").click()
        time.sleep(3)
        print("工程施工专责审核成功!!!")
